...
const CustomerOrderDetails = lazy(
  () => import("../admin/order/CustomerOrderDetails")
);
...
const Table: React.FC<TableProps> = ({
  ...
  const [showOrderCustomerModal, setShowOrderCustomerModal] =
  ...
  const [orderCustomerPreview, setOrderCustomerPreview] =
    useState<AllOrderUserResultData>({
      image: [],
      address: "",
      customerName: "",
      email: "",
        ...
        {data &&
          ...
          data.map((row, index) => (
            <div
              ...
              className={`my-4 ${lightgrayBgColor} w-full rounded-lg border-b border-gray-300 py-4 px-2`}
            >
              {columns &&
                ...
                columns.map((col, b) => {
                  ...
                  return (
                    <div
                      key={b}
                      className="w-full grid grid-cols-[42%_53%] items-center gap-3 p-2 border-b border-gray-300/50 break-words whitespace-normal"
                    >
                      <CustomText
                        text={col.label}
                        textType="normal"
                      ...
                      <div className="text-gray-500 text-[9px] sm:text-[12px]">
                        ...
                        label.toLowerCase() === "image" ? (
                        ...
                        ) : whichTable.toLowerCase() === "customerorder" &&
                          ...
                          <div
                            ...
                            className="rounded-lg p-2 bg-white w-max"
                          >
                                  ...
                                  onClick={() => {
                                    ...
                                    if (
                                      ...
                                      const deleteProduct = (id: string) => {
                                        ...
                                        if (confirmDelete)
                                          proceedTodeleteProduct(id);
                                      };

                                      const proceedTodeleteProduct = (
                                        id: string
                                      ) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        row[col.key].includes("Actions") ? (
                              ...
                              onClick={() => {
                                ...
                                if (whichTable.toLowerCase() === "product") {
                                  ...
                                  const proceedTodeleteProduct = (
                                    ...
                                    dispatch(deleteproduct(id)).then(() =>
                                      dispatch(
                                        invalidateFetchAllProductCache(false)
                                      )
                                    );
                                  };
                          ...
                          <div
                            className={`rounded-lg p-2 ${lightgrayBgColor} w-max`}
                          >
                            <img
                              src={row[col.key]}
                              alt="image prescription"
