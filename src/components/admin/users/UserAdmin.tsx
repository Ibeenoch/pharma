...
const UserAdmin: React.FC<UserAdminProps> = ({ users }) => {
  ...
  const filteredData: UserMappedProps[] =
    users && Array.isArray(users) ? mappedUser(users) : [];
  ...
  const handleUserFilter = () => {
    ...
    dispatch(getAllUsersWithDateFilter(data));
  };
  ...
  return (
    <section>
      <DateFilter
        ...
        applyCallback={handleUserFilter}
      />
