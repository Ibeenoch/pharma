...
const AdminUsers = () => {
  ...
  return (
    <main className={`md:mt-12 mt-20 p-4 w-full ${adminDefaultBgColor}`}>
      <section className="flex items-center gap-3 md:mx-3">
        {userStatitics.map((user) => (
          <div className="rounded-xl bg-gradient-to-r from-amber-600 to-amber-300 p-4 w-full md:w-1/2 h-[150px] my-2 flex justify-between gap-2 items-center">
