...
const Category = () => {
    const productImages = [painKiller1, fever1, antibiotics1, coughCold1, chronic1, vitMin1, famplan1];
    const categories = [
        'Pain Killers',
        'Fever & Malarial',
        'Antibiotics',
            ...
            productImages.map((item, index) => (
                ...
                <div className='cursor-pointer'>
                    <div className=' rounded-xl p-5 bg-white mb-4'>
                        <img src={item} alt="medication categories" className='w-46 h-auto object-fit' />
                    </div>
                    <article>
                        <CustomText text={categories[index]} textType='normal' weightType='bold' />
                        <div className='flex gap-3 items-center'>
                            <CustomText text='₦1500' textType='small' weightType='bold' color='text-amber-500' />
                            <CustomText text='₦2000' textType='small' weightType='bold' color='gray' extraStyle='line-through' />
                        </div>
                    </article>
                </div>
            ))
