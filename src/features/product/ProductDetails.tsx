...
const ProductDetails = () => {
  ...
  return (
    <>
    <section className={`${MARGIN_TOP}  md:grid grid-cols-2  mb-1 border-b border-gray-300`}>
      ...
      <div className="mt-5 p-4">
       ...
       <CustomText
        ...
        <div className="group flex items-center  gap-3 border border-gray-300 rounded-xl">
          <div onClick={decreaseNum} className="group-hover:bg-amber-500 group-hover:rounded-xl cursor-pointer p-2">
            <Minus className="w-4 h-4 cursor-pointer group-hover:text-white group-hover:stroke-white" />
          </div>
          <p className="text-md">{qty}</p>
          <div onClick={increaseNum} className="group-hover:bg-amber-500 group-hover:rounded-xl cursor-pointer p-2">
    ...
    <section className="my-3">
      <CustomText text="You May Also Like"  textType="large"
          weightType="semibold" extraStyle="my-3"/>

      <div className="flex items-center gap-2">
        <SingleProduct productImage={img3} price="₦4,100" textTitle="Procold" textDesc="Relieves Cold, flu symptoms, nasal congestion, and fever"/>
        <SingleProduct productImage={img3} price="₦4,100" textTitle="Procold" textDesc="Relieves Cold, flu symptoms, nasal congestion, and fever"/>
        <SingleProduct productImage={img3} price="₦4,100" textTitle="Procold" textDesc="Relieves Cold, flu symptoms, nasal congestion, and fever"/>
        <SingleProduct productImage={img3} price="₦4,100" textTitle="Procold" textDesc="Relieves Cold, flu symptoms, nasal congestion, and fever"/>
        <SingleProduct productImage={img3} price="₦4,100" textTitle="Procold" textDesc="Relieves Cold, flu symptoms, nasal congestion, and fever"/>
